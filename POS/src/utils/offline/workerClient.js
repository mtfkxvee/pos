...
class OfflineWorkerClient {
	...
	async cacheItemsFromServer(posProfile) {
		return this.sendMessage("CACHE_ITEMS_FROM_SERVER", { posProfile })
	}

	async cacheCustomersFromServer(posProfile) {
		return this.sendMessage("CACHE_CUSTOMERS_FROM_SERVER", { posProfile })
	}
