<template>
	<!-- Management Sidebar - Hidden on Mobile, Visible on Desktop -->
	<div class="hidden lg:flex w-16 flex-shrink-0 bg-white border-e border-gray-200 flex-col items-center py-4 flex flex-col gap-2">
		...
		<button
			...
			class="w-12 h-12 rounded-lg flex items-center justify-center transition-all relative group text-gray-600 hover:bg-gray-100"
